...
import com.adventnet.authentication.An.AAAPASSWORD;
import com.adventnet.authentication.AAAAAACCOUNT;
import com.adventnet.authenticatioACCPASSWORD;
...
public class HodAuth extends HttpServlet{
	public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException{
		String loginName = "hod";
		...
		try
		{
			...
			authRoleRow1.set("ROLE_ID", AuthUtil.getRoleId("HOD"));
